...
class sfProjectDeployTask extends sfBaseTask
{
  ...
  protected function configure()
  {
    ...
    $this->addOptions(array(
      ...
      new sfCommandOption('rsync-options', null, sfCommandOption::PARAMETER_OPTIONAL, 'To options to pass to the rsync executable', '-azCv --force --delete --progress'),
    ));
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    throw new sfCommandException($command);
